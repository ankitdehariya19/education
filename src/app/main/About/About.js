            ...
            <div className='tab-content mt-6 md:mt-10'>
              <div className={`content pt-4 md:pt-6 pb-6 ${toggleTab === 1 ? '' : 'hidden'}`}>
                ...
                <ul className='list-disc list-inside text-base md:text-lg leading-7 md:leading-8 font-normal text-gray-200'>
                  <li>Comprehensive Content: Our content covers a wide spectrum of subjects, ensuring that there's something for everyone.</li>
              ...
              <div className={`content pt-4 md:pt-6 pb-6 ${toggleTab === 2 ? '' : 'hidden'}`}>
                ...
                <p className='text-base md:text-lg leading-7 md:leading-8 font-normal text-gray-200'>
                  Don't miss out on the latest updates and educational resources. Subscribe to our newsletter to receive regular insights, tips, and announcements.
                </p>
                <p className='text-base md:text-lg leading-7 md:leading-8 font-normal text-gray-200'>
                  We're excited to have you embark on your learning journey with us!
                </p>
              </div>
              ...
              <div className={`content pt-4 md:pt-6 pb-6 ${toggleTab === 3 ? '' : 'hidden'}`}>
                ...
                <p className='text-base md:text-lg leading-7 md:leading-8 font-normal text-gray-200'>
                  With over a decade of experience in education, the Gyanohm team has successfully impacted the lives of thousands of learners. Our instructors come from diverse backgrounds and have expertise in a wide range of subjects. We're proud of the positive outcomes our learners have achieved through our programs.
                </p>
                ...
                <p className='text-base md:text-lg leading-7 md:leading-8 font-normal text-gray-200'>
                  Our commitment to excellence drives us to continuously enhance our teaching methods and update our content to meet the evolving needs of learners. We combine years of experience with a passion for innovative education, ensuring that every learner's journey is engaging, enriching, and impactful.
                </p>
                ...
                <p className='text-base md:text-lg leading-7 md:leading-8 font-normal text-gray-200'>
                  The impact of our education reaches beyond the digital realm. We're proud to have contributed to the success stories of professionals, students, and lifelong learners. From career advancements to newfound passions, our programs have empowered individuals to excel in their pursuits.
                </p>
              </div>
